...
```bash
git clone https://github.com/actionanand/svg-forge.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/svg-forge#1-skeleton angular-proj-name
```
